...
read in the CSV file and calculated each teams victories, losses and number of games played in order to pass on the relavant info to the different files.

I was able to dynamically create my show.erb file for each team's specific info. The only thing I wasn't able to do
was to create a function that would populate my leaderboard table. I had a hard time finding a way to dynamically create and sort my table without entering the info in myself. I tried several time but I wasn't able to get the final layout/results I wanted.
